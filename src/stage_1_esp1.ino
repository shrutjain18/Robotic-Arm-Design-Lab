...
void setup() {
  ...
  float initialAngle1 = map(analogRead(feedbackPotPin1), 0, 4095, 0, 300);
  float initialAngle2 = map(analogRead(feedbackPotPin2), 0, 4095, 0, 300);
...
void loop() {
  ...
  int pwm2 = constrain(abs((int)output2), 230, 255);
  ...
  Serial.print(" ");
  Serial.print(map(analogRead(feedbackPotPin1), 0, 4095, 0, 300));
  Serial.print(" | ");

  Serial.print("M2 T:"); Serial.print(target2);
  Serial.print(" A:"); Serial.print(actual2);
  Serial.print(" ");
  Serial.print(map(analogRead(feedbackPotPin2), 0, 4095, 0, 300));
